...
class Knjiga {
    ...
    public:
        ...
        bool DaLiJeZaduzena() const{ if(zaduzeni){return true;} return false; }
...
class Biblioteka {
    ...
    public:
        ...
        Student &NadjiStudenta(int indeksKorisnika) const;
